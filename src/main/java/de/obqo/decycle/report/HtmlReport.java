...
import static de.obqo.decycle.report.MarkupReader.inlineMarkup;
import static de.obqo.decycle.report.MarkupReader.inlineMarkup_min;
    ...
    public void writeReport(final Graph graph, final List<Constraint.Violation> violations, final Appendable out,
        ...
        final var html = html().withLang("en").with(
                head(
                        ...
                        minify ? styleWithInlineFile_min("/report/custom.css") :
                                styleWithInlineFile("/report/custom.css"),
                        ...
                        script().withSrc("https://code.jquery.com/jquery-3.6.0.min.js")
                                ...
                                .attr("crossorigin", "anonymous"),
                        minify ? scriptWithInlineFile_min("/report/custom.js") :
                                scriptWithInlineFile("/report/custom.js")
                ),
                body(
                        div(
                                minify ? inlineMarkup_min("/report/logo.svg") : inlineMarkup("/report/logo.svg"),
                                hr().withClass("mt-1"),
                                h1("Violation Report"),
                                violationDiv,
                                each(sliceSections),
                                hr(),
                                div(small(String.format("Generated by Decycle %s",
